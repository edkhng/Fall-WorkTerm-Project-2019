...
fitparams1, fitcov1 = curve_fit(fit_function, bins4[:-1], n4, p0=guesses1, maxfev=100000)
fitparams2, fitcov2 = curve_fit(fit_function, bins5[:-1], n5, p0=guesses2, maxfev=100000)
fitparams3, fitcov3 = curve_fit(bi_gaussian, bins4[:-1], n4, p0=guesses3, maxfev=100000)
...
f = open('C:/Users/Edmond Ng/Documents/WorkTerm 2/Data/{} TeV/fitting_params_bi_gaussian_tau_all.csv'.format(neutrino_energy), 'a+')
# f.write('# pos1, pos2, wid1, wid2, amp1, amp2, r1, r2\n')
f.write('{}, {}, {}, {}, {}, {}, {}, {}\n'.format(*fitparams1))
...
f = open('C:/Users/Edmond Ng/Documents/WorkTerm 2/Data/{} TeV/fitting_params_bi_gaussian_e_all.csv'.format(neutrino_energy), 'a+')
# f.write('# pos1, pos2, wid1, wid2, amp1, amp2, r1, r2\n')
f.write('{}, {}, {}, {}, {}, {}, {}, {}\n'.format(*fitparams2))
# f.write('# pos1, pos2, wid1, wid2, amp1, amp2, r1, r2, upos1, upos2, uwid1, uwid2, uamp1, uamp2, ur1, ur2')
